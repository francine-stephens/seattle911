...
The set of descriptive and spatial analyses in this web-report is a follow up on the [preliminary exploratory analysis](https://francine-stephens.github.io/francinestephens.github.io/cad19_eda.html). We take a deeper dive into the cases that had the clear by description "No police action possible or necessary." This report tackles two questions about this type of resolution, which will henceforth be abreviated as NPAPN:
...
18,8447 calls about cases that had been resolved by NPAPN had valid geographic coordinates that could be mapped. These point locations have been mapped and aggregated to the Seattle Police Department's geographic units as well as a density raster grid constructed using 1/8th of a square mile areal units.
...
* Just to norhwest of Sector K, Sector M had about half the number of calls resolved by NPAPN. 
...
## Take-aways & Lingering Questions 