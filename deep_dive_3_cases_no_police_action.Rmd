...
The hot spots and few cold spots can be viewed in the interactive map. They are more localized because I used a 1/8th square mile pixel grid to build the raster. Pan and zoom in to the different beats to see where the "hot spots" are located (e.g., near parks, transit stations, etc.)
