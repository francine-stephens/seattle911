...
**Call priority codes and Call type description** have a manageable number of categories - 9 and 8, respectively. *Call type has 8 possible categories, but we are only focusing on two categories - 911 and other telephone (not 911).* After taking a deeper dive into the univariate statistics in the sections below and understanding what these categories mean, we can decide whether any of these categories should be aggregated. 
